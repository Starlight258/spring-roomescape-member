...
public record ReservationPreservationResponse(Long id, String name, LocalDate date,
    ...
    public static ReservationPreservationResponse from(final Reservation reservation) {
        return new ReservationPreservationResponse(reservation.getId(), reservation.getMember().getName(),
